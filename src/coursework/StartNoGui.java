...
public class StartNoGui {
	...
	public static void main(String[] args) {
		...
		Parameters.popSize = 200; // Population Size (starting 200)

		//number of hidden nodes in the neural network
		Parameters.setHidden(11);
		...
		ArrayList<Double> fitnessList_test = new ArrayList<Double>();
		ArrayList<Double> fitnessList_train = new ArrayList<Double>();
		...
		for (int i = 0; i < 4; i++) 
		{
			...
			fitnessList_train.add(nn.best.fitness);
			...
			fitnessList_test.add(fitness);
		}
		
		System.out.println();
		System.out.println("Training fitness:");
		for (Double i : fitnessList_train) {
			System.out.println(i);
		}
		
		System.out.println();
		System.out.println("Testing fitness:");
		for (Double i : fitnessList_test) {
			System.out.println(i);
		}
